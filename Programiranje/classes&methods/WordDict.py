...
class WordDict():
    def __init__(self,velikost):
        self.velikost_p = dict(velikost)
        self.velikost = dict(((ime.lower(),v) for ime, v in velikost))

    def __str__(self):
        return str(self.velikost_p)

    __repr__ = __str__

    def __len__(self):
        return len(self.velikost)

    def __getitem__(self, item):
        return self.velikost[item.lower()]

    def __setitem__(self, key, value):
        k = key.lower()
        self.velikost_p[k] = (key, value)

    def keys(self):
        return self.velikost_p.keys()

    def values(self):
        return self.velikost_p.values()

    def items(self):
        return self.velikost_p.items()
